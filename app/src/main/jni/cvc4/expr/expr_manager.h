 ...
 **
 **     ../../../src/expr/mkexpr ../../../src/expr/expr_manager_template.h ../../../src/theory/builtin/kinds ../../../src/theory/booleans/kinds ../../../src/theory/uf/kinds ../../../src/theory/arith/kinds ../../../src/theory/bv/kinds ../../../src/theory/fp/kinds ../../../src/theory/arrays/kinds ../../../src/theory/datatypes/kinds ../../../src/theory/sep/kinds ../../../src/theory/sets/kinds ../../../src/theory/strings/kinds ../../../src/theory/quantifiers/kinds ../../../src/theory/idl/kinds
 **
...
#line 37 "../../../src/expr/expr_manager_template.h"
...
template <> Expr ExprManager::mkConst(::CVC4::UninterpretedConstant const& val);

#line 276 "../../../src/theory/builtin/kinds"
template <> Expr ExprManager::mkConst(::CVC4::AbstractValue const& val);

#line 287 "../../../src/theory/builtin/kinds"
template <> Expr ExprManager::mkConst(::CVC4::Kind const& val);

#line 306 "../../../src/theory/builtin/kinds"
template <> Expr ExprManager::mkConst(::CVC4::Chain const& val);

#line 312 "../../../src/theory/builtin/kinds"
template <> Expr ExprManager::mkConst(::CVC4::TypeConstant const& val);

#line 339 "../../../src/theory/builtin/kinds"
template <> Expr ExprManager::mkConst(::CVC4::Predicate const& val);

#line 21 "../../../src/theory/booleans/kinds"
template <> Expr ExprManager::mkConst(bool const& val);

#line 30 "../../../src/theory/arith/kinds"
template <> Expr ExprManager::mkConst(::CVC4::Divisible const& val);

#line 49 "../../../src/theory/arith/kinds"
template <> Expr ExprManager::mkConst(::CVC4::SubrangeBounds const& val);

#line 62 "../../../src/theory/arith/kinds"
template <> Expr ExprManager::mkConst(::CVC4::Rational const& val);

#line 15 "../../../src/theory/bv/kinds"
template <> Expr ExprManager::mkConst(::CVC4::BitVectorSize const& val);

#line 24 "../../../src/theory/bv/kinds"
template <> Expr ExprManager::mkConst(::CVC4::BitVector const& val);

#line 85 "../../../src/theory/bv/kinds"
template <> Expr ExprManager::mkConst(::CVC4::BitVectorBitOf const& val);

#line 91 "../../../src/theory/bv/kinds"
template <> Expr ExprManager::mkConst(::CVC4::BitVectorExtract const& val);

#line 97 "../../../src/theory/bv/kinds"
template <> Expr ExprManager::mkConst(::CVC4::BitVectorRepeat const& val);

#line 103 "../../../src/theory/bv/kinds"
template <> Expr ExprManager::mkConst(::CVC4::BitVectorZeroExtend const& val);

#line 109 "../../../src/theory/bv/kinds"
template <> Expr ExprManager::mkConst(::CVC4::BitVectorSignExtend const& val);

#line 115 "../../../src/theory/bv/kinds"
template <> Expr ExprManager::mkConst(::CVC4::BitVectorRotateLeft const& val);

#line 121 "../../../src/theory/bv/kinds"
template <> Expr ExprManager::mkConst(::CVC4::BitVectorRotateRight const& val);

#line 135 "../../../src/theory/bv/kinds"
template <> Expr ExprManager::mkConst(::CVC4::IntToBitVector const& val);

#line 16 "../../../src/theory/fp/kinds"
template <> Expr ExprManager::mkConst(::CVC4::FloatingPoint const& val);

#line 24 "../../../src/theory/fp/kinds"
template <> Expr ExprManager::mkConst(::CVC4::RoundingMode const& val);

#line 41 "../../../src/theory/fp/kinds"
template <> Expr ExprManager::mkConst(::CVC4::FloatingPointSize const& val);

#line 134 "../../../src/theory/fp/kinds"
template <> Expr ExprManager::mkConst(::CVC4::FloatingPointToFPIEEEBitVector const& val);

#line 146 "../../../src/theory/fp/kinds"
template <> Expr ExprManager::mkConst(::CVC4::FloatingPointToFPFloatingPoint const& val);

#line 159 "../../../src/theory/fp/kinds"
template <> Expr ExprManager::mkConst(::CVC4::FloatingPointToFPReal const& val);

#line 171 "../../../src/theory/fp/kinds"
template <> Expr ExprManager::mkConst(::CVC4::FloatingPointToFPSignedBitVector const& val);

#line 183 "../../../src/theory/fp/kinds"
template <> Expr ExprManager::mkConst(::CVC4::FloatingPointToFPUnsignedBitVector const& val);

#line 196 "../../../src/theory/fp/kinds"
template <> Expr ExprManager::mkConst(::CVC4::FloatingPointToFPGeneric const& val);

#line 211 "../../../src/theory/fp/kinds"
template <> Expr ExprManager::mkConst(::CVC4::FloatingPointToUBV const& val);

#line 223 "../../../src/theory/fp/kinds"
template <> Expr ExprManager::mkConst(::CVC4::FloatingPointToSBV const& val);

#line 35 "../../../src/theory/arrays/kinds"
template <> Expr ExprManager::mkConst(::CVC4::ArrayStoreAll const& val);

#line 41 "../../../src/theory/datatypes/kinds"
template <> Expr ExprManager::mkConst(::CVC4::DatatypeIndexConstant const& val);

#line 73 "../../../src/theory/datatypes/kinds"
template <> Expr ExprManager::mkConst(::CVC4::AscriptionType const& val);

#line 88 "../../../src/theory/datatypes/kinds"
template <> Expr ExprManager::mkConst(::CVC4::TupleUpdate const& val);

#line 96 "../../../src/theory/datatypes/kinds"
template <> Expr ExprManager::mkConst(::CVC4::RecordUpdate const& val);

#line 18 "../../../src/theory/sets/kinds"
template <> Expr ExprManager::mkConst(::CVC4::EmptySet const& val);

#line 61 "../../../src/theory/strings/kinds"
template <> Expr ExprManager::mkConst(::CVC4::String const& val);

#line 67 "../../../src/theory/strings/kinds"
template <> Expr ExprManager::mkConst(::CVC4::RegExp const& val);
